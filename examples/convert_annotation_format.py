...
annot.to_yolo(os.path.join(project_root, 'outputs'), os.path.join(project_root, 'outputs', 'class.names'))
annot.to_pascal(os.path.join(project_root, 'outputs'))
annot.to_coco(os.path.join(project_root, 'outputs'))
